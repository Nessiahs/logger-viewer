...
import { IConsoleError } from "../../db/logDb";
...
export const ErrorDetailEntry: React.FunctionComponent<TLogDeatilEntryProps> = (
  props
) => {
  ...
  return (
    <>
      ...
      <div
        ...
        <pre>{JSON.stringify(JSON.parse(props.callstack), undefined, 2)}</pre>
      </div>
    </>
  );
};
